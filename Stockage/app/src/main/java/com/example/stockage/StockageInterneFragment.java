...
public class StockageInterneFragment extends Fragment {
    ...
    public StockageInterneFragment() {
    ...
    private File getFile(String fileName) {
        return new File(requireActivity().getFilesDir(), fileName);
    }

    private File getCacheFile(String fileName) {
        return new File(requireActivity().getCacheDir(), fileName);
    }
}